...
public class SnakeHuntingGameActivity extends TITSingleGameActivity
{
    @Override
    protected TITGameControl linkControl()
    {
        return TITApplication.getScreenControlManager().getSaSnakeHuntingControl();
    }
    ...
    {
        return new SnakeHuntingGameResource(this);
    }

    @Override
    public TITScene initScene()
    {
        return new SnakeHuntingGameSence();
    }
}
