...
public class ZXBrick extends Brick
{
    public ZXBrick(TetrisGameControl iControl,int iRunTimeMillis)
    {
        ...
        BrickItem brickItem;
        brickItem=BrickItem.createBrickItem(3,centerRow,centerColumn-1,iControl);
        birckItemArr.add(brickItem);
        brickItem=BrickItem.createBrickItem(3,centerRow,centerColumn,iControl);
        birckItemArr.add(brickItem);
        brickItem=BrickItem.createBrickItem(3,centerRow-1,centerColumn-1,iControl);
        birckItemArr.add(brickItem);
        brickItem=BrickItem.createBrickItem(3,centerRow-1,centerColumn-2,iControl);
        birckItemArr.add(brickItem);
