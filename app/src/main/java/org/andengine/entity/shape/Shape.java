...
public abstract class Shape extends Entity implements IShape {
	...
	protected int mBlendFunctionSource = BLENDFUNCTION_SOURCE_DEFAULT;
	protected int mBlendFunctionDestination = BLENDFUNCTION_DESTINATION_DEFAULT;
	...
	public void reset() {
		...
		this.mBlendFunctionSource = BLENDFUNCTION_SOURCE_DEFAULT;
		this.mBlendFunctionDestination = BLENDFUNCTION_DESTINATION_DEFAULT;
	}
