...
import org.andengine.AndengineFunction;
...
public class Entity implements IEntity
{
    ...
    private static final ParameterCallable<IEntity> PARAMETERCALLABLE_DETACHCHILD =
            new ParameterCallable<IEntity>()
            {
                @Override
    ...
    {
        return (int) syncMChildrenMethod("getChildCount",null,null);
    }

    @Override
    public IEntity getChildByTag(final int pTag)
    {
        return (IEntity) syncMChildrenMethod("getChildByTag",pTag,null);
    }

    @Override
    public IEntity getChildByIndex(final int pIndex)
    {
        return (IEntity) syncMChildrenMethod("getChildByIndex",pIndex,null);
    }

    @Override
    public IEntity getChildByMatcher(final IEntityMatcher pEntityMatcher)
    {
        return (IEntity) syncMChildrenMethod("getChildByMatcher",pEntityMatcher,null);
    }

    @Override
    public IEntity getFirstChild()
    {
        return (IEntity) syncMChildrenMethod("getFirstChild",null,null);
    }

    @Override
    public IEntity getLastChild()
    {
        return (IEntity) syncMChildrenMethod("getLastChild",null,null);
    }
    ...
    {
        return (S) syncMChildrenMethod("queryFirstForSubclass",pEntityMatcher,null);
    }

    @Override
    public <L extends List<IEntity>> L query(final IEntityMatcher pEntityMatcher, final L pResult)
    {
        return (L) syncMChildrenMethod("query",pEntityMatcher,pResult);
    }

    @SuppressWarnings("unchecked")
    @Override
    public <L extends List<S>, S extends IEntity> L queryForSubclass(final IEntityMatcher
                                                                             pEntityMatcher, final L pResult) throws ClassCastException
    {
        return (L) syncMChildrenMethod("queryForSubclass",pEntityMatcher,pResult);
    }

    @Override
    public boolean detachSelf()
    {
        return (boolean) syncMChildrenMethod("detachSelf",null,null);
    }

    @Override
    public void detachChildren()
    {
        syncMChildrenMethod("detachChildren",null,null);
    }

    @Override
    public void attachChild(final IEntity pEntity) throws IllegalStateException
    {
        syncMChildrenMethod("attachChild",pEntity,null);
    }

    @Override
    public void sortChildren(final boolean pImmediate)
    {
        syncMChildrenMethod("sortChildren",pImmediate,null);
    }

    @Override
    public void sortChildren(final IEntityComparator pEntityComparator)
    {
        syncMChildrenMethod("sortChildren",pEntityComparator,null);
    }

    @Override
    public boolean detachChild(final IEntity pEntity)
    {
        return (boolean) syncMChildrenMethod("detachChild",pEntity,null);
    }

    @Override
    public IEntity detachChild(final int pTag)
    {
        return (IEntity) syncMChildrenMethod("detachChild",pTag,null);
    }

    @Override
    public IEntity detachChild(final IEntityMatcher pEntityMatcher)
    {
        return (IEntity) syncMChildrenMethod("detachChild",pEntityMatcher,null);
    }

    @Override
    public boolean detachChildren(final IEntityMatcher pEntityMatcher)
    {
        return (boolean) syncMChildrenMethod("detachChildren",pEntityMatcher,null);
    }

    @Override
    public void callOnChildren(final IEntityParameterCallable pEntityParameterCallable)
    {
        syncMChildrenMethod("callOnChildren",pEntityParameterCallable,null);
    }
    ...
    {
        syncMChildrenMethod("callOnChildren",pEntityParameterCallable,pEntityMatcher);
    }

    @Override
    public void toString(final StringBuilder pStringBuilder)
    {
        syncMChildrenMethod("toString",pStringBuilder,null);
    }

    protected void onManagedDraw(final GLState pGLState, final Camera pCamera)
    {
        syncMChildrenMethod("onManagedDraw",pGLState,pCamera);
    }

    synchronized protected Object syncMChildrenMethod(String methodName,Object param1,Object param2)
    {
        ...
        {
            case "getChildCount":
                return syncGetChildCount();
            case "getChildByTag":
                pTag=(Integer) param1;
                return syncGetChildByTag(pTag);
            case "getChildByIndex":
                int pIndex=(Integer) param1;
                return syncGetChildByIndex(pIndex);
            case "getChildByMatcher":
                pEntityMatcher=(IEntityMatcher) param1;
                return syncGetChildByMatcher(pEntityMatcher);
            case "getFirstChild":
                return syncGetFirstChild();
            case "getLastChild":
                return syncGetLastChild();
            case "queryFirstForSubclass":
                pEntityMatcher=(IEntityMatcher) param1;
                return syncQueryFirstForSubclass(pEntityMatcher);
            case "query":
                pEntityMatcher=(IEntityMatcher) param1;
                return syncQuery(pEntityMatcher,param2);
            case "queryForSubclass":
                pEntityMatcher=(IEntityMatcher) param1;
                return syncQueryForSubclass(pEntityMatcher,param2);
            case "detachSelf":
                return syncDetachSelf();
            case "detachChildren":
                if(param1==null)
                    syncDetachChildren();
                else
                {
                    pEntityMatcher=(IEntityMatcher) param1;
                    syncDetachChildren(pEntityMatcher);
                }
                break;
            case "attachChild":
                IEntity pEntity=(IEntity) param1;
                syncAttachChild(pEntity);
                break;
            case "sortChildren":
                if(param1 instanceof Boolean)
                {
                    boolean pImmediate = (boolean) param1;
                    syncSortChildren(pImmediate);
                }
                else
                {
                    IEntityComparator pEntityComparator=(IEntityComparator) param1;
                    syncSortChildren(pEntityComparator);
                }
                break;
            case "detachChild":
                if(param1 instanceof IEntity)
                {
                    IEntity iEntity=(IEntity) param1;
                    return syncDetachChild(iEntity);
                }

                if(param1 instanceof Integer)
                {
                    pTag=(int) param1;
                    return syncDetachChild(pTag);
                }

                if(param1 instanceof TagEntityMatcher)
                {
                    IEntityMatcher iEntityMatcher=(IEntityMatcher) param1;
                    return syncDetachChild(iEntityMatcher);
                }
                break;
            case "callOnChildren":
                IEntityParameterCallable pEntityParameterCallable=
                        (IEntityParameterCallable) param1;
                if(param2==null)
                    syncCallOnChildren(pEntityParameterCallable);
                else
                {
                    pEntityMatcher=(IEntityMatcher) param2;
                    syncCallOnChildren(pEntityParameterCallable,pEntityMatcher);
                }
                break;
            case "resetMChildren":
                syncResetMChildren();
                break;
            case "toString":
                StringBuilder pStringBuilder=(StringBuilder) param1;
                syncToString(pStringBuilder);
                break;
            case "onManagedDraw":
                GLState pGLState=(GLState) param1;
                Camera pCamera=(Camera) param2;
                syncOnManagedDraw(pGLState,pCamera);
                break;
            case "onManagedUpdateMChildren":
                float pSecondsElapsed=(float) param1;
                syncOnManagedUpdateMChildren(pSecondsElapsed);
                break;
        }
        return null;
    }

    protected int syncGetChildCount()
    {
    ...
    protected IEntity syncGetChildByTag(final int pTag)
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected IEntity syncGetChildByIndex(final int pIndex)
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected IEntity syncGetChildByMatcher(final IEntityMatcher pEntityMatcher)
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected IEntity syncGetFirstChild()
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected IEntity syncGetLastChild()
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected <S extends IEntity> S syncQueryFirstForSubclass(final IEntityMatcher pEntityMatcher)
    {
    ...
    protected <L extends List<IEntity>> L syncQuery(final IEntityMatcher pEntityMatcher, final Object pOResult)
    {
        L pResult=(L) pOResult;
        final int childCount = this.getChildCount();
        for(int i = 0; i < childCount; i++)
        {
            final IEntity child = this.mChildren.get(i);
    ...
    protected <L extends List<S>, S extends IEntity> L syncQueryForSubclass(final IEntityMatcher
                                                                                    pEntityMatcher, final Object pOResult) throws ClassCastException
    {
        L pResult=(L) pOResult;
        final int childCount = this.getChildCount();
        for(int i = 0; i < childCount; i++)
    ...
    protected boolean syncDetachSelf()
    {
    ...
    protected void syncDetachChildren()
    {
        if(this.mChildren == null)
        {
            return;
    ...
    protected void syncAttachChild(final IEntity pEntity) throws IllegalStateException
    {
    ...
    protected void syncSortChildren(final boolean pImmediate)
    {
        if(this.mChildren == null)
        {
            return;
    ...
    protected void syncSortChildren(final IEntityComparator pEntityComparator)
    {
        if(this.mChildren == null)
        {
            return;
    ...
    protected boolean syncDetachChild(final IEntity pEntity)
    {
        if(this.mChildren == null)
        {
            return false;
    ...
    protected IEntity syncDetachChild(final int pTag)
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected IEntity syncDetachChild(final IEntityMatcher pEntityMatcher)
    {
        if(this.mChildren == null)
        {
            return null;
    ...
    protected boolean syncDetachChildren(final IEntityMatcher pEntityMatcher)
    {
        if(this.mChildren == null) {
            return false;
        }
    ...
    protected void syncCallOnChildren(final IEntityParameterCallable pEntityParameterCallable)
    {
        if(this.mChildren == null)
        {
            return;
    ...
    /* (non-Javadoc)
     * @see IEntity#convertLocalToSceneCoordinates(float, float)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IEntity#convertLocalToSceneCoordinates(float, float, float[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IEntity#convertLocalToSceneCoordinates(float[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IEntity#convertSceneToLocalCoordinates(float, float)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IEntity#convertSceneToLocalCoordinates(float, float, float[])
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see IEntity#convertSceneToLocalCoordinates(float[])
     */
    @Override
    ...
    public void reset()
    {
        ...
        syncMChildrenMethod("resetMChildren",null,null);
    }

    protected void syncResetMChildren()
    {
        if(this.mChildren != null)
        {
    ...
    public void syncToString(final StringBuilder pStringBuilder)
    {
    ...
    protected void syncOnManagedDraw(final GLState pGLState, final Camera pCamera)
    {
    ...
    protected void onManagedUpdate(final float pSecondsElapsed)
    {
        ...
        try {
            ...
            syncMChildrenMethod("onManagedUpdateMChildren", pSecondsElapsed, null);
        }
        catch (Exception ex){}
    }

    protected void syncOnManagedUpdateMChildren(final float pSecondsElapsed)
    {
