...
public class BuildableTextureAtlas<S extends ITextureAtlasSource, T extends ITextureAtlas<S>> implements IBuildableTextureAtlas<S, T> {
	...
	/**
	 * @see {@link BuildableBitmapTextureAtlas#setTextureStateListener(ITextureAtlas.ITextureAtlasStateListener)}
	 */
	@Deprecated
	@Override
	...
	@Override
	public void setTextureAtlasStateListener(final ITextureAtlas.ITextureAtlasStateListener<S> pTextureAtlasStateListener) {
