...
public class BaseCollisionChecker {
	 ...
	 * return value can be either 1, -1, or 0 and indicates in which vector
	 ...
	 * vector that takes the positive X axis towards the negative Y axis. In
	 * the default coordinate system used by Java 2D, this vector is
	 * counterclockwise.
	 * <p>
	 * A return value of -1 indicates that the line segment must turn in the
	 * vector that takes the positive X axis towards the positive Y axis. In
	 * the default coordinate system, this vector is clockwise.
	 * <p>
	...
	public static int relativeCCW(final float pX1, final float pY1, float pX2, float pY2, float pPX, float pPY) {
		...
		if (ccw == 0.0f) {
			...
			// outside of the segment in the vector of the particular
